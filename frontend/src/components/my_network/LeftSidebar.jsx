const LeftSidebar = ({totalSent, totalReceived , totalConnections}) => {
  return (
    <aside className="hidden md:block w-1/4 bg-white rounded-lg shadow-sm p-4 self-start sticky top-20 text-black">
      ...
      <ul className="text-sm text-gray-600 space-y-2">
        <li>Connections: {totalConnections} </li>
        <li>Invites sent: {totalSent} </li>
        <li>Invites received: {totalReceived} </li>        
      </ul>
    </aside>
  );
};
